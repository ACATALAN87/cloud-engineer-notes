...
const experience: Role[] = [
  {
    ...
    current: true,
    bullets: [
      'Aprovisionamiento de infraestructura Azure mediante Infrastructure as Code con Terraform.',
      'Troubleshooting de incidencias de networking en Azure (VNets, NSGs, peerings y conectividad híbrida).',
      'Integración de Azure DevOps y GitHub con Azure Data Factory, dando soporte a equipos de desarrollo en la puesta en marcha de pipelines de datos.',
      'Configuración y soporte continuo de Azure DevOps: service connections, agent pools, pipelines y políticas de despliegue.',
      'Gestión de usuarios y grupos en la plataforma Conduktor (gobernanza de Apache Kafka).',
      'Administración integral de Appian: despliegue de aplicaciones, gestión de usuarios y permisos, mantenimiento y configuración de la plataforma.',
      'Despliegue automatizado de clústeres Couchbase Capella vía GitHub Actions e IaC, incluyendo el VNet peering con la suscripción Azure corporativa.',
      'Provisioning y administración de Snowflake: configuración de la plataforma, gestión de usuarios y modelo RBAC.',
      'Resolución de incidencias en producción sobre Azure, Azure DevOps y Azure Data Factory.',
    ],
  },
  {
    company: 'Kyndryl',
